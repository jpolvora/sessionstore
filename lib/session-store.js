const EventEmitter = require('events'),
  ...
  util = require('util'),
  MemoryStore = require('./sessionstore-memory'),
  MongooseStore = require('./sessionstore-mongo')
...
const SessionStore = (function () {
  ...
  SessionStore.prototype.checkInit = async function () {
    if (!!this.init) return;
    this.init = true;
    if (!this.store) this.store = new MemoryStore();
    // if (!this.store) this.store = new MongooseStore({
